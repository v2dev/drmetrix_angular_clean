...
function alert_email($user_name, $user_id, $frequency='weekly', $report_filter, $name_of_report_filter, $id) {
   ob_start();

   $images_url       = "http://".HOST ."/drmetrix/api/email-template/images/";
   $unsubscribe_url  = "http://".HOST ."/drmetrix/tracking?data=".base64_encode("kind=subscribe_email&type=filter&type_id=$id&user_id=$user_id");
            ...
            <tr style="padding: 0; text-align: left; vertical-align: top;">
               <td class="float-center" align="center" valign="top" style="-moz-hyphens: auto; -webkit-hyphens: auto; Margin: 0 auto; border-collapse: collapse !important; color: #0a0a0a; float: none; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; hyphens: auto; line-height: 1.3; margin: 0 auto; padding: 0; text-align: center; vertical-align: top; word-wrap: break-word;">
                  <center data-parsed="" style="min-width: 580px; width: 100%;">
                                                ...
                                                <tbody>
                                                   <tr style="padding: 0; text-align: left; vertical-align: top;">
                                                      ...
                                                      <th class="small-12 columns" style="Margin: 0 auto; color: #0a0a0a; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0 auto; padding: 0; padding-bottom: 16px; padding-left: 40px; text-align: left; vertical-align: middle;">
                                                         ...
                                                         <!--p class="small-text-center sub-details" style="Margin: 0; Margin-bottom: 10px; color: #202b39; font-family: Helvetica, Arial, sans-serif; font-size: 20px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; text-align: left;">
                                                         Here is your<?php echo $frequency?> alert update for <?php echo date("M d, Y")?>
                                                         </p-->
                                                      </th>
                                                   </tr>
                                                </tbody>
                     ...
                     <!-- table -->
                     <p>
                        You have scheduled this email for <?php echo $report_filter; ?> named "<strong><?php echo $name_of_report_filter; ?></strong>" which shall arrive on a <strong><?php echo str_replace(',', ' and ', $frequency); ?></strong> basis. Should you wish to change/delete your settings please click <a href="<?php echo $unsubscribe_url; ?>">here</a>.
                     </p>
