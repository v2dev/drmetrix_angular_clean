angular.
  ...
  component('categoryPart', { 
    template:
        `<nav class="sidebar">
        <a  href="" class="open-left-sidebar-nav slideBtn" id="slidebtn" ng-click="cateorySideBar = !cateorySideBar;"> 
            <i data-feather="align-justify"></i>
            <span>Categories</span>
        </a>
        <div class="sidebar-sticky sidenav scrollbar" id="sidenav"  ng-class="cateorySideBar == 1 ? 'addWidthAndLeft' : 'minusWidthAndLeft'">
            <div class="d-flex justify-content-between align-items-center position-relative">
                <div class="checkbox">
                    ...
                    <label for="checkbox5_all" class="checkbox-custom-label full-filled">
                        <span class="v-align-middle">All Categories</span></label>
                </div>
                ...
                <a href="" class="close-left-sidebar-nav slideBtn" id="slidebtn" ng-click="cateorySideBar = !cateorySideBar;">
                    <i data-feather="align-justify"></i>
                </a>
            </div>
            <ul ng-repeat="item in $ctrl.category_list" class="menu-bar vertical no-bullet" id="categories_list">
                <li>
                    <div class="checkbox" data-toggle="collapse" href="#collapseExample" role="button"
                        ...
                        <label for="checkbox_{{item.category_id}}" class="checkbox-custom-label full-filled" ng-class="$ctrl.selectedValue(item)">
                            <span class="v-align-middle">{{item.category}}</span>
                    ...
                    <ul ng-show="$ctrl.subCategory">
                        <li id="all_categories" ng-repeat="subitem in item.subcategory" class="checkbox">
                            ...
                            <label for="label_{{subitem.sub_category_id}}" custom-id="label_{{subitem.sub_category_id}}" class="checkbox-custom-label full-filled">
                                <span class="custom-label-sub-div">{{subitem.sub_category}}</span>
                            </label>
                        </li>
                    </ul>
                </li>
