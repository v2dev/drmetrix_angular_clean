                ...
                gridApi.expandable.on.rowExpandedStateChanged($scope, function (row) {
                    ...
                    if (row.isExpanded) {
                        row.entity.subGridOptions = {
                            ...
                            { name: 'airings', displayName:'Airings', cellTemplate:'<a href="#"><span ng-if="row.entity.airings!=\'\'" class="ranking_airings" ng-click="viewAiringGraph(row.entity.brand_name,row.entity.id,\'airings\',\'brand\');">{{COL_FIELD}} </span><span ng-if="row.entity.airings==\'\'"> - </span></a>'  },
                            { name: 'spend_index', displayName: 'Spend',  cellTemplate: '<a href=""><span ng-if="row.entity.spend_index!=\'\'" class="ranking_airings" ng-click="viewAiringSpendGraph(row.entity.brand_name,row.entity.id,\'total_spend\',\'brand\');">{{COL_FIELD}}</span><span ng-if="row.entity.spend_index==\'\'"> - </span></a>' },
