    ...
    // formData.network_code = '';
        ...
        .then(function (response) {
            ...
            vm.gridOptions.columnDefs = [
                ...
                { field: 'brand_name', displayName: 'Brand', headerCellClass: $scope.highlightFilteredHeader, cellTemplate: '<div class="grid-action-cell"><span ng-if="'+$rootScope.displayBtns+'==1" '+$rootScope.displayBtns+'><i class="fa fa-circle" id="{{data.rows.is_active_brand == 1 ? \'active_btn\' : \'inactive_btn\'}}"></i></span><span><a href="" ui-sref="advertiser_detail({id: row.entity.adv_id, tab: \'brand\'})" title="row.entity.brand_name">{{COL_FIELD}}</a></span></div>', sort: { direction: uiGridConstants.ASC, priority: 1 }},
                ...
                { name: 'advertiser_name', displayName: 'Advertiser', cellTemplate:'<a href="#" ng-if="row.entity.advertiser_name!=\'\'" class="tooltip-hover" ui-sref="advertiser_detail({id: row.entity.adv_id, tab: \'adv\'})">{{COL_FIELD}}</a><span ng-if="row.entity.advertiser_name==\'\'"> - </span></a>'},
