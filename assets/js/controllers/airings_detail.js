...
$scope.uigridAiringSpend = function(){
            ...
            gridApi.expandable.on.rowExpandedStateChanged($scope, function (row) {
                ...
                if (row.isExpanded) {
                    row.entity.subAiringGridOptions = {
                        ...
                        { name: 'airings', displayName:'Total Airings', cellTemplate:'<a href="" ui-sref="rosdaypart_detail({id : row.entity.id, area: \'airings\', tab: \'creative\'})">{{COL_FIELD}}</a>' ,defaultSort: {
                            direction: uiGridConstants.ASC,
                            priority: 0
                            } },
                        { name: 'total_spend', displayName:'Total Spend ($)',cellTemplate: '<a href="" ui-sref="rosdaypart_detail({id : row.entity.id, area: \'total_spend\', tab: \'creative\'})">{{COL_FIELD}}</a>' },
    ...
    vm.gridAiringSpend.columnDefs = [
        ...
        { name: 'airings', pinnedLeft:true, displayName:'Total Airings', cellTemplate:'<a href="" ui-sref="rosdaypart_detail({id : row.entity.id, area: \'airings\', tab: \'brand\'})">{{COL_FIELD}}</a>' },

        { name: 'total_spend', pinnedLeft:true, displayName:'Total Spend', cellTemplate: '<a href="" ui-sref="rosdaypart_detail({id : row.entity.id, area: \'total_spend\', tab: \'brand\'})">{{COL_FIELD}}</a>' },
